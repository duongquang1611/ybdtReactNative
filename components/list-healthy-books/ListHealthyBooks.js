...
import HealthyBooks from "./healthy-books/HealthyBooks";
import { TouchableOpacity } from "react-native-gesture-handler";

class renderListHealthyBooks extends Component {
  static navigationOptions = {
    title: "Danh sách lần khám"
  }
  constructor(props) {
    super(props);
    this.state = {
        ...
        <View style={styles.container}>
          <FlatList
            ...
            renderItem={({ item, index }) => (
              <TouchableOpacity
                onPress={() => this.props.navigation.navigate("HealthyBooks", { Id: item.Id, ChanDoan: item.ChanDoan, navigation: this.props.navigation })}
              >
...
export default renderListHealthyBooks;
