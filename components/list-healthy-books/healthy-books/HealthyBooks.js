...
class HealthyBooks extends Component {
  ...
  render() {
    const { navigation } = this.props;
    const navigationParent = navigation.getParam("navigation", "No-navigation");
                ...
                <FlatList
                  ...
                  renderItem={({ item, index }) => (
                    <TouchableWithoutFeedback
                      onPress={() => navigationParent.navigate("CLSDetailReport_InHealthyBooks", { IdPhieuIn: item })}
                    >
